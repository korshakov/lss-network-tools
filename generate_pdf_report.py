...
def render_about_report(pdf):
    ...
    pdf.multi_cell(
        170, 5,
        safe("This report was produced by LSS Network Tools, a network audit tool developed by "
             "LS Solutions Software. Each section corresponds to a specific test or scan carried "
             "out on the client's network. The table below explains what each task does and why "
             "it matters, in plain terms."),
        new_x="LMARGIN", new_y="NEXT",
    )
    pdf.ln(4)
